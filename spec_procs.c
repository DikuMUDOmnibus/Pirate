...
int agent(struct char_data *ch, int cmd, char *arg)
{
	...
	{
		case 0:
			do_say(ch, "get away or i'll bust you!", 0);
		   return(1);
		case 1:
			do_say(ch, "Have you considered becoming a narc?", 0);
			return(1);
		case 2:
                        do_say(ch, "Spread em!", 0);
			do_say(ch, "Your under arrest!", 0);
			return(1);
		case 3:
			do_say(ch, "Get a life loser!", 0);
			return(1);
		default:
			return(0);
	}
...
int druid(struct char_data *ch, int cmd, char *arg)
{
	...
	{
	case 0:
		do_say(ch, "Hey, you seen any narcs or feds arround?", 0);
		return(1);
	case 1:
		do_say(ch, "Hey man you got a code or pbx I can have?", 0);
		return(1);
	case 2:
		do_say(ch, "Hey you got a calling card or cc?", 0);
		return(1);
	case 3:
		do_say(ch, "Betcha I have more root accounts than you do!", 0);
		return(1);
	default:
		return(0);
	}
